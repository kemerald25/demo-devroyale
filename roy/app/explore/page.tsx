...
export default function Explore() {
  ...
  const spots = [
    { id: 1, title: 'Roy Quest Hub', description: 'Curated missions, Base-native actions, and rapid progression loops.' },
    ...
    { id: 4, title: 'Dev Royale Updates', description: 'Fresh templates, UI kits, and flows specifically for Roy builders.' },
  ];
